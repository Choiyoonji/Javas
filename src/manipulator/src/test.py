...
angle=test_link.inverse_kinematics(target_position=[0,30,20],target_orientation=[[1,0,0],[0,-1,0],[0,0,-1]],orientation_mode="all")
print(angle)
...
test_link.plot(test_link.inverse_kinematics(target_position=[0,30,20],target_orientation=[[1,0,0],[0,-1,0],[0,0,-1]],orientation_mode="all"), ax) #각도는 순서대로 (OriginLink, First, Second, Third, Fourth), OriginLink는 0 라디안 고정
plt.show()
